...
Questions:
    ...
    #The range of the data is 478,800.
    2: Number of rows  
    #The number of row is 10.
    3: Number of rows cut with filter  
    #There are 1658 rows total in the spreadsheet, so 1648 of them have been cut for this summary.
...
Questions:
    ...
    #The median for editors is 60,240.
    3: Find highest paid editor. Resent them.   
    #The highest paid editor is an editorial director at CondeNast with a salary of $245,000.
    4: Make a table for any position involving data  
    #There are only two positions involving data on the spreadsheet.
...
```{r}
#The highest paid position at NYT is an executive editor for news. The editor makes $350,000 and is Black and did not input a gender.
```
...
```{r}
#The median salary for Bloomberg is $50,000, and the highest paid position is a senior editor for BloombergNews. The editor makes $210,000 and is white and male.
